...
public class ByteUtils {
     ...
     * @return
     */
    public static String intToTwoHex(int number) {
        if (number > 65535) {
            return "0000";
        }
        return String.format("%04x",number).toUpperCase();
    }
    ...
    public static byte[] byteMerger(byte[] bt1,byte[] bt2) {
        ...
        System.arraycopy(bt1,0,result,0,xLen);
        System.arraycopy(bt2,0,result,xLen,yLen);
        return result;
    }
}
